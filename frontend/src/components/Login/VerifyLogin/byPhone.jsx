...
const firebaseConfig = {
  apiKey: "AIzaSyAcLNwzpKQM33aLucKI2ps0ppbYmsU17kU",
  authDomain: "seochohi-73acf.firebaseapp.com",
  projectId: "seochohi-73acf",
  storageBucket: "seochohi-73acf.appspot.com",
  messagingSenderId: "26463712589",
  appId: "1:26463712589:web:26051e79760a1f57ce3304",
};
...
export default function ByPhone(props) {
    ...
    signInWithPhoneNumber(auth, PhoneNumber, appVerifier)
      ...
      .catch((e) => {
        ...
        let auth_codes = {
          ...
          "auth/quota-exceeded":
            "요청 횟수 한도를 초과하였습니다. 다른 인증 수단을 사용해주세요.",
        };
      ...
      .catch((e) => {
        switch (e.code) {
          ...
          default:
            console.log(e.code);
            alert(
              "오류가 발생하였습니다. 잠시 후 다시 시도하거나 다른 인중 수단을 사용해주세요."
            );
            break;
        }
      });
  ...
  return (
    <>
      ...
      <span>
        <small>
          휴대전화 메시지를 확인해주세요. 인증 코드를 받지 못했을 경우 차단된
          메시지를 확인해주세요. 또는{" "}
