    ...
    <div>
      <p className="ls2 lh6 bs5 ts4">
        <span className="spanphasis">
          &lt; 2022 서초고 스타트업 동아리 &gt;('https://www.seochohi.com'이하
          '서초하이')
        </span>
      ...
      <p className="ls2">
        학교 내 이벤트 및 광고성 정보 제공 및 참여기회 제공 등을 목적으로
        개인정보를 처리합니다.
      </p>
      <p>
        <br />
      ...
      <p className="lh6 bs4">
        ...
        은(는) 법령에 따른 개인정보 보유&middot;이용기간 또는 정보주체로부터
        개인정보를 수집 시에 동의받은 개인정보 보유&middot;이용기간 내에서
      ...
      <ul className="list_indent2 mgt10">
        <li className="tt">1&lt; 홈페이지 회원가입 및 관리 &gt;</li>
        <li>
          필수항목 : 학생정보, 성별, 이름, 생년월일, 비밀번호, 서비스 이용 기록,
          접속 로그, 쿠키, 접속 IP 정보
        </li>
      ...
      <p className="lh6 bs4">
        ...
        은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를
        위탁하고 있습니다.
      </p>
      <ul className="list_indent2 mgt10">
      ...
      <p className="ls2">
        <span className="spanphasis">
          ...
          1. 파기절차
          <br />
          &lt; 2022 서초고 스타트업 동아리 &gt; 은(는) 파기 사유가 발생한
          개인정보를 선정하고, &lt; 2022 서초고 스타트업 동아리 &gt; 의 개인정보
      ...
      <p className="lh6 bs4">
        <strong>
          제7조(정보주체와 법정대리인의 권리&middot;의무 및 그 행사방법에 관한
          사항)
        </strong>
      </p>
      <p className="ls2">
      ...
      <p className="sub_p">
        ② 제1항에 따른 권리 행사는2022 서초고 스타트업 동아리에 대해 「개인정보
        보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
        통하여 하실 수 있으며 2022 서초고 스타트업 동아리은(는) 이에 대해 지체
        없이 조치하겠습니다.
      </p>
      <p className="sub_p">
      ...
      <p className="sub_p">
        ⑥ 2022 서초고 스타트업 동아리은(는) 정보주체 권리에 따른 열람의 요구,
      ...
      <p className="sub_p mgt10">
        ...
        &gt;('
        <span className="spanphasis">서초하이</span>')은 해킹이나 컴퓨터
        바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을
        설치하고 주기적인 갱신&middot;점검을 하며 외부로부터 접근이 통제된
        ...
        3. 접속기록의 보관 및 위변조 방지
        <br />
        개인정보처리시스템에 접속한 기록을 최소 1개월 이상 보관, 관리하고
        있습니다.
        <br />
      ...
      <p className="lh6 bs4">
        <strong>
          제9조(개인정보를 자동으로 수집하는 장치의 설치&middot;운영 및 그
          거부에 관한 사항)
        </strong>
      </p>
      <p className="ls2">
        <br />
        <br />① 2022 서초고 스타트업 동아리 은(는) 이용자에게 개별적인
        ...
        <br />
        나. 쿠키의 설치&bull;운영 및 거부 : 웹브라우저 상단의 도구&gt;인터넷
      ...
      <p className="lh6 bs4">
        <strong>
          제10조(행태정보의 수집&middot;이용&middot;제공 및 거부 등에 관한 사항)
        </strong>
      </p>
      <p className="ls2">
        <br />
      ...
      <p className="sub_p mgt10">
        ...
        <span>&nbsp;</span>은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
      ...
      <p className="sub_p">
        ② 정보주체께서는 2022 서초고 스타트업 동아리 의 서비스(또는 사업)을
        이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제
        등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
        2022 서초고 스타트업 동아리 은(는) 정보주체의 문의에 대해 지체 없이 답변
        및 처리해드릴 것입니다.
      </p>
      <p className="sub_p mgt30">
        <strong>
          ...
          아래의 부서에 할 수 있습니다.
          <br />
          &lt; 2022 서초고 스타트업 동아리 &gt;은(는) 정보주체의 개인정보
      ...
      <p></p>
      <p className="sub_p">
        ① 이 개인정보처리방침은 2022년 11월 30부터 적용됩니다.
      </p>
      <p></p>
    </div>
  );
