...
import { useMediaQuery } from "react-responsive"; //반응형
  ...
  if (isIE) {
    return (
      <div style={{ textAlign: "center" }}>
        <strong>
          이 웹사이트는 인터넷 익스플로러를 지원하지 않습니다. 다른 브라우저를 이용해주시기
          바랍니다.
        </strong>
      </div>
    );
    ...
    <ThemeProvider theme={Theme}>
      <TransitionGroup className="App">
        <CSSTransition
          ...
          unmountOnExit
        >
          <div className="container" id={ThemeType === "dark" ? "dark" : "light"}>
            {/* PC 버전 접근 방지 */}
            ...
            {isTabletOrMobile && (
              <>
                ...
                <Routes location={location}>
                  ...
                  />
                  <Route path="/register" element={<Register name="회원가입" />} />

                  <Route path="/wiki/schedule" element={<WikiSchedule name="학사일정" />} />
                  <Route path="/wiki/lunch" element={<WikiLunch name="급식" />} />
                  <Route path="/wiki/exams" element={<WikiExams name="기출" />} />
                  <Route path="/wiki/teachers" element={<WikiTeachers name="선생님" />} />

                  <Route path="/announcement" element={<Announcement name="공지사항" />} />

                  <Route path="/forest" element={<Forest name="서초고숲" />} />
                  <Route path="/forest/:tag/:uid/:pid" element={<ForestMore name="서초고숲" />} />

                  <Route path="/forest/new" element={<ForestNew name="글쓰기" />} />

                  <Route path="/time/event/notes" element={<TimeNotes name="필기공유" />} />
                ...
                */}
                  ...
                  <Route path="/myclass/timetable" element={<MyClassTimeTable name="시간표" />} />
                  <Route path="/myclass/quicknotes" element={<MyClassQuickNotes name="메모장" />} />
                  <Route
                ...
                */}
                  <Route path="/support" element={<Support name="FAQ 및 문의" />} />
                  <Route
                    path="/settings"
                    element={
                      <Settings
                  ...
                  <Route path="/privacy" element={<Privacy name="개인정보처리방침" />} />
                  {/* Not Found Page */}
